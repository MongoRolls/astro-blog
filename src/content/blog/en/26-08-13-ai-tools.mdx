...
5. For a resident local agent with WeChat as an entry point, use [Hermes](/en/blog/26-08-17-hermes/#hermes-agent).
6. To expose a CLI subscription as an API for other clients, use [CLIProxyAPI](/en/blog/26-08-17-hermes/#cliproxyapi).
