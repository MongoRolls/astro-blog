...
<img src="https://mongorolls-images.oss-cn-shenzhen.aliyuncs.com/blog/24-01-06-git/image-20240521225459227.png" alt="Git 配置示例截图" />
...
<img src="https://mongorolls-images.oss-cn-shenzhen.aliyuncs.com/blog/24-01-06-git/image-20240521230522586.png" alt="Git 命令执行结果截图" />
...
```bash
git clone <仓库URL> [--depth=1] [目标目录名]
```

从远程仓库下载项目到本地。
`<仓库URL>`：远程仓库的地址
--depth=1：可选参数，只克隆最新提交的历史记录，减少下载量
[目标目录名]：可选参数，指定克隆到本地后的文件夹名称
